...
function initModels(sequelizeTasker, sequelizeDiven) {
  var acquisti = _acquisti(sequelizeDiven, DataTypes);
  var acquisti_commesse = _acquisti_commesse(sequelizeDiven, DataTypes);
  var ana_operatori = _ana_operatori(sequelizeDiven, DataTypes);
  var ana_tipologie = _ana_tipologie(sequelizeDiven, DataTypes);
  var anagrafiche = _anagrafiche(sequelizeDiven, DataTypes);
  var archives = _archives(sequelizeTasker, DataTypes);
  var associazioni_ditte_dogane = _associazioni_ditte_dogane(sequelizeDiven, DataTypes);
  var cdm_associazioni = _cdm_associazioni(sequelizeDiven, DataTypes);
  var cdm_campi = _cdm_campi(sequelizeDiven, DataTypes);
  var cdm_competenze = _cdm_competenze(sequelizeDiven, DataTypes);
  var cdm_letture = _cdm_letture(sequelizeDiven, DataTypes);
  var cdm_marche = _cdm_marche(sequelizeDiven, DataTypes);
  var codici_importo_commessa = _codici_importo_commessa(sequelizeDiven, DataTypes);
  var commesse = _commesse(sequelizeDiven, DataTypes);
  var commesse_associate = _commesse_associate(sequelizeDiven, DataTypes);
  var commesse_sb = _commesse_sb(sequelizeDiven, DataTypes);
  var condomini = _condomini(sequelizeDiven, DataTypes);
  var contract_of_employment = _contract_of_employment(sequelizeTasker, DataTypes);
  var costo_operatori = _costo_operatori(sequelizeDiven, DataTypes);
  var crediti_commesse = _crediti_commesse(sequelizeDiven, DataTypes);
  var credito_debito = _credito_debito(sequelizeDiven, DataTypes);
  var credito_utilizzato = _credito_utilizzato(sequelizeDiven, DataTypes);
  var ditte_dogane = _ditte_dogane(sequelizeDiven, DataTypes);
  var docs_fornitori = _docs_fornitori(sequelizeDiven, DataTypes);
  var dogane = _dogane(sequelizeDiven, DataTypes);
  var dogane_des = _dogane_des(sequelizeDiven, DataTypes);
  var domande = _domande(sequelizeDiven, DataTypes);
  var domande_soddisfazione_cl = _domande_soddisfazione_cl(sequelizeDiven, DataTypes);
  var el_categorie = _el_categorie(sequelizeDiven, DataTypes);
  var el_classificazioni = _el_classificazioni(sequelizeDiven, DataTypes);
  var el_dipendenti = _el_dipendenti(sequelizeDiven, DataTypes);
  var el_personas = _el_personas(sequelizeDiven, DataTypes);
  var el_ruoli = _el_ruoli(sequelizeDiven, DataTypes);
  var el_servizi = _el_servizi(sequelizeDiven, DataTypes);
  var el_settori = _el_settori(sequelizeDiven, DataTypes);
  var el_sottocategorie = _el_sottocategorie(sequelizeDiven, DataTypes);
  var fatt_tipologie = _fatt_tipologie(sequelizeDiven, DataTypes);
  var fatturazione = _fatturazione(sequelizeDiven, DataTypes);
  var fatturazione_commesse = _fatturazione_commesse(sequelizeDiven, DataTypes);
  var fotovoltaico = _fotovoltaico(sequelizeDiven, DataTypes);
  var gruppo_operatori = _gruppo_operatori(sequelizeDiven, DataTypes);
  var gt_timetable = _gt_timetable(sequelizeDiven, DataTypes);
  var hours = _hours(sequelizeTasker, DataTypes);
  var impostazioni_utente = _impostazioni_utente(sequelizeDiven, DataTypes);
  var indicatori = _indicatori(sequelizeDiven, DataTypes);
  var indicatori_obiettivi = _indicatori_obiettivi(sequelizeDiven, DataTypes);
  var installatori = _installatori(sequelizeDiven, DataTypes);
  var ip_bloccati = _ip_bloccati(sequelizeDiven, DataTypes);
  var marche_sim = _marche_sim(sequelizeDiven, DataTypes);
  var metodi_lettura = _metodi_lettura(sequelizeDiven, DataTypes);
  var monitoraggio_oda = _monitoraggio_oda(sequelizeDiven, DataTypes);
  var operatori_commesse = _operatori_commesse(sequelizeDiven, DataTypes);
  var operatori_task = _operatori_task(sequelizeDiven, DataTypes);
  var overtime = _overtime(sequelizeTasker, DataTypes);
  var pagamenti = _pagamenti(sequelizeDiven, DataTypes);
  var pagamenti_task = _pagamenti_task(sequelizeDiven, DataTypes);
  var permessi_operatori = _permessi_operatori(sequelizeDiven, DataTypes);
  var pratiche_enea = _pratiche_enea(sequelizeDiven, DataTypes);
  var preventivi = _preventivi(sequelizeDiven, DataTypes);
  var preventivi_commesse = _preventivi_commesse(sequelizeDiven, DataTypes);
  var provvigioni = _provvigioni(sequelizeDiven, DataTypes);
  var qualifiche = _qualifiche(sequelizeDiven, DataTypes);
  var qualifiche_operatori = _qualifiche_operatori(sequelizeDiven, DataTypes);
  var rinnovo_cpi = _rinnovo_cpi(sequelizeDiven, DataTypes);
  var scia_antincendio = _scia_antincendio(sequelizeDiven, DataTypes);
  var servizi_classificazione = _servizi_classificazione(sequelizeDiven, DataTypes);
  var settore_operatori = _settore_operatori(sequelizeDiven, DataTypes);
  var shifts = _shifts(sequelizeTasker, DataTypes);
  var soddisfazione_cliente = _soddisfazione_cliente(sequelizeDiven, DataTypes);
  var storico_attivita_svolte = _storico_attivita_svolte(sequelizeDiven, DataTypes);
  var storico_ricariche_sim = _storico_ricariche_sim(sequelizeDiven, DataTypes);
  var subtask = _subtask(sequelizeTasker, DataTypes);
  var task_fatturazione = _task_fatturazione(sequelizeDiven, DataTypes);
  var task_programmazione = _task_programmazione(sequelizeDiven, DataTypes);
  var task_subtask = _task_subtask(sequelizeTasker, DataTypes);
  var tasks = _tasks(sequelizeTasker, DataTypes);
  var ticket = _ticket(sequelizeDiven, DataTypes);
  var ticket_commesse = _ticket_commesse(sequelizeDiven, DataTypes);
  var ticket_operatori = _ticket_operatori(sequelizeDiven, DataTypes);
  var timetable = _timetable(sequelizeDiven, DataTypes);
  var tipologia_cl_soddisfazione_cl = _tipologia_cl_soddisfazione_cl(sequelizeDiven, DataTypes);
  var tipologie_credito = _tipologie_credito(sequelizeDiven, DataTypes);
  var todo = _todo(sequelizeDiven, DataTypes);
  var users = _users(sequelizeTasker, DataTypes);
  var valori_qualita = _valori_qualita(sequelizeDiven, DataTypes);
  var valori_stagionali_ditte_dogane = _valori_stagionali_ditte_dogane(sequelizeDiven, DataTypes);
